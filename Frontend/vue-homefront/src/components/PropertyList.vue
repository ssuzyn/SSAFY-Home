<template>
    <div class="bg-white h-full overflow-auto">
      ...
      <ul class="divide-y divide-gray-200">
        <li v-for="property in properties" :key="property.id" class="px-4 py-4 sm:px-6 hover:bg-gray-50 cursor-pointer" @click="selectProperty(property)">
          ...
          <div class="mt-2 sm:flex sm:justify-between">
            <div class="sm:flex">
              <p class="flex items-center text-sm text-gray-500">
                {{ property.size }}m² · {{ property.floor }}/{{ property.totalFloors }}층
              </p>
            </div>
