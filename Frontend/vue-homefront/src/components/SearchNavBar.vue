        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            ...
            <div class="ml-4 flex items-baseline space-x-4">
              <a href="#" class="text-gray-700 hover:text-orange-500 px-3 py-2 rounded-md text-sm font-medium">홈</a>
              <a href="#" class="text-gray-700 hover:text-orange-500 px-3 py-2 rounded-md text-sm font-medium">매물</a>
              <a href="#" class="text-gray-700 hover:text-orange-500 px-3 py-2 rounded-md text-sm font-medium">뉴스</a>
            </div>
          </div>
          <div class="flex items-center">
            <div class="relative">
